// ssarray_test_suites.cpp
// Glenn G. Chappell
// 12 Sep 2018
//
// For CS 311 Fall 2018
// Tests for class template SSArray: test suites
// For Project 2, Exercise A
// Uses the "Catch" unit-testing framework, version 2
// Requires ssarray_test_main.cpp, catch.hpp, ssarray.h
           ...
           "[types]" )
{
    SECTION( "Member type value_type" )
    {
        ...
        int & r1(x1);
        (void)r1;  // Avoid unused-variable warning

        // value_type (SSArray<double>)
        SSArray<double>::value_type x2;
        double & r2(x2);
        (void)r2;  // Avoid unused-variable warning
           ...
           "[types]" )
{
    ...
    SECTION( "Copy assn returns SSArray by reference" )
    {
        SSArray<int> & r(mi1 = cmi2);
        (void)r;  // Avoid unused-variable warning
        REQUIRE( TypeCheck<SSArray<int>>::check(mi1 = cmi2) );
    }

    SECTION( "Move assn returns SSArray by reference" )
    {
        SSArray<int> mi_movable1;
        SSArray<int> mi_movable2;
        SSArray<int> & r(mi1 = move(mi_movable1));
        (void)r;  // Avoid unused-variable warning
    ...
    SECTION( "Bracket op (const) returns item by ref-to-const" )
    {
        ...
        const SSArray<int>::value_type & r2(cmi2[0]);
        (void)r2;  // Avoid unused-variable warning
        REQUIRE( TypeCheck<SSArray<int>::value_type>::check(cmi2[0]) );

        const double & r3(cmd5[0]);
        (void)r3;  // Avoid unused-variable warning
        REQUIRE( TypeCheck<double>::check(cmd5[0]) );
        const SSArray<double>::value_type & r4(cmd5[0]);
        (void)r4;  // Avoid unused-variable warning
    ...
    SECTION( "Bracket op (non-const) returns item by ref" )
    {
        ...
        SSArray<int>::value_type & r2(mi1[0]);
        (void)r2;  // Avoid unused-variable warning
        ...
        SSArray<double>::value_type & r4(md4[0]);
        (void)r4;  // Avoid unused-variable warning
    ...
    SECTION( "size returns size_type by value" )
    {
        ...
        SSArray<int>::size_type && r2(cmi2.size());
        (void)r2;  // Avoid unused-variable warning
        REQUIRE( TypeCheck<SSArray<int>::size_type>::check(cmi2.size()) );

        size_t && r3(cmd5.size());
        (void)r3;  // Avoid unused-variable warning
        SSArray<int>::size_type && r4(cmd5.size());
        (void)r4;  // Avoid unused-variable warning
    ...
    SECTION( "begin (const) returns ptr-to-item by value" )
    {
        ...
        const SSArray<int>::value_type * && r2(cmi2.begin());
        (void)r2;  // Avoid unused-variable warning
        ...
        const SSArray<double>::value_type * && r4(cmd5.begin());
        (void)r4;  // Avoid unused-variable warning
    ...
    SECTION( "begin (non-const) returns ptr-to-item by value" )
    {
        ...
        SSArray<int>::value_type * && r2(mi1.begin());
        (void)r2;  // Avoid unused-variable warning
        ...
        SSArray<double>::value_type * && r4(md4.begin());
        (void)r4;  // Avoid unused-variable warning
    ...
    SECTION( "end (const) returns ptr-to-item by value" )
    {
        ...
        const SSArray<int>::value_type * && r2(cmi2.end());
        (void)r2;  // Avoid unused-variable warning
        ...
        const SSArray<double>::value_type * && r4(cmd5.end());
        (void)r4;  // Avoid unused-variable warning
    ...
    SECTION( "end (non-const) returns ptr-to-item by value" )
    {
        ...
        SSArray<int>::value_type * && r2(mi1.end());
        (void)r2;  // Avoid unused-variable warning
        ...
        SSArray<double>::value_type * && r4(md4.end());
        (void)r4;  // Avoid unused-variable warning
...
TEST_CASE( "Functions take const arguments (passes if it compiles)",
           "[types]" )
{
    SECTION( "Taking const SSArray arguments" )
    {
        ...
        bool result1 = (cmi1 == cmi2);  // op==(SSArray,SSArray)
        (void)result1;  // Avoid unused-variable warning
        bool result2 = (cmi1 != cmi2);  // op!=(SSArray,SSArray)
        (void)result2;  // Avoid unused-variable warning
        bool result3 = (cmi1 <  cmi2);  // op<(SSArray,SSArray)
        (void)result3;  // Avoid unused-variable warning
        bool result4 = (cmi1 <= cmi2);  // op<=(SSArray,SSArray)
        (void)result4;  // Avoid unused-variable warning
        bool result5 = (cmi1 >  cmi2);  // op>(SSArray,SSArray)
        (void)result5;  // Avoid unused-variable warning
        bool result6 = (cmi1 >= cmi2);  // op>=(SSArray,SSArray)
        (void)result6;  // Avoid unused-variable warning
