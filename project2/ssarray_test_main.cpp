// ssarray_test_main.cpp
// Glenn G. Chappell
// 12 Sep 2018
//
// For CS 311 Fall 2018
// Tests for class template SSArray: main program
// For Project 2, Exercise A
// Uses the "Catch" unit-testing framework, version 2
// Requires ssarray_test_suites.cpp, catch.hpp, ssarray.h
...
int main(int argc,
         char *argv[])
{
    const std::string tname = "class template SSArray"
                              " - CS 311 Proj 2, Ex A";
