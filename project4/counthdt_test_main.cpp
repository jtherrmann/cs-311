// counthdt_test_main.cpp
// Glenn G. Chappell
// 27 Sep 2018
//
// For CS 311 Fall 2018
// Tests for function countHDT: main program
// For Project 4, Exercise A
// Uses the "Catch" unit-testing framework, version 2
// Requires counthdt_test_suites.cpp, catch.hpp, counthdt.h,
//  counthdt.cpp
...
int main(int argc,
         char *argv[])
{
    const std::string tname = "function countHDT"
                              " - CS 311 Proj 4, Ex A";
